...
final class WordCounts {
  ...
  static Map<String, Integer> sort(Map<String, Integer> wordCounts, int popularWordCount) {
    ...
    Stream<Map.Entry<String, Integer>> wordCountSet =
      wordCounts
        .entrySet()
        .stream()
        .sorted(
          new WordCountComparator()
        )
        .limit(
          Math.min(
            popularWordCount,
    ...
    return wordCountSet
      .collect(
        Collectors.toMap(
          stringIntegerEntry1 -> stringIntegerEntry1.getKey(),
          stringIntegerEntry2 -> stringIntegerEntry2.getValue(),
          (key, value) -> {
            return key;
        }, () -> new LinkedHashMap<>()
      )
